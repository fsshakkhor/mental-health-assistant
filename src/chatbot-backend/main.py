...
Original file is located at
    https://colab.research.google.com/drive/1CiXTWePXcVxlvlOCU87Gus7kuvz0fGGt
"""
...
# cd drive/MyDrive/Colab\ Notebooks/test\ 2
...
if __name__ == '__main__':
    while True:
        In = input('Type Here: ').lower()
        print(chatbot_response(In)[0])
